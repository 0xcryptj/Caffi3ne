...
export default function PricingPage() {
  return (
    <section className="relative mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div className="pointer-events-auto absolute inset-0 z-30 flex items-start justify-center bg-canvas/50 px-4 pt-16 backdrop-blur-sm sm:pt-24">
        <div className="max-w-md rounded-2xl border border-espresso-200 bg-white p-8 text-center shadow-panel">
          <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-espresso-400">API pricing</p>
          ...
          <p className="mt-3 text-sm leading-7 text-espresso-600">
            Developer and API plans are not on sale yet. Use the app for live discovery and crowd intelligence; we will announce API access separately.
          </p>
          <Link
            href="/nearby"
